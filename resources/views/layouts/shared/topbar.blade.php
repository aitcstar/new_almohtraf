    ...
    <!--
            ...
            <li class="dropdown notification-list topbar-dropdown">
                <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    ...
                    {{{ isset(Auth::user()->firstname) ? Auth::user()->firstname . ' ' . Auth::user()->familyname : Auth::user()->email }}}
 <i class="mdi mdi-chevron-down"></i>
        ...
        <div class="logo-box">
            ...
            <a href="/home" class="logo logo-light text-center">
                <span class="logo-sm">
                    <img src="{{url('frontend/images/Nlogo.png')}}" alt="Logo" height="20" >
                </span>
                <span class="logo-lg">
                        <img src="{{url('frontend/images/Nlogo.png')}}" alt="Logo" height="50" >
                </span>
            </a>
        </div>
