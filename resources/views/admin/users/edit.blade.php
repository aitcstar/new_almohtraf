            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('usersUpdate',['admin','users' ,'update'])  }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ $users->name }}" required>
                        @if($errors->has('name'))
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{  $users->email  }}" required>
                        @if($errors->has('email'))
                        ...
                        <div class="row">
                            <div class="mb-2 col-md-2">
                                ...
                                <select name="code" id="code" class="form-control" required>
                                    ...
                                    <option value="+965" {{($users->code=='+965')?' selected':''}} > kuwait (+965)</option>
                                    <option value="+20" {{($users->code=='+20')?' selected':''}}>Egypt (+20)</option>
                                </select>
                                @if($errors->has('code'))
                            ...
                            <div class="mb-10 col-md-10">
                                ...
                                <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone" id="phone" value="{{  $users->phone  }}" required>
                                @if($errors->has('phone'))
