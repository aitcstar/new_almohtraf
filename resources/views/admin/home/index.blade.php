        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">المشاريع</h4>
                </div>
            </div>
        ...
        @foreach ($statusSummary as $status)
            <div class="col-md-6 col-xl-4">
                <div class="widget-rounded-circle card-box">
                    <div class="row">
                        <div class="col-6">
                            <div class="avatar-lg rounded-circle  border" style="background-color: {{ $status['status_color']}}">
                                <i class="fa fa-fw fa-cubes font-22 avatar-title"></i>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="text-right">
                                <h3 class="text-dark mt-1"><span data-plugin="counterup">{{ $status['count'] }}</span></h3>
                                <p class="text-muted mb-1 text-truncate"> {{ $status['status_name'] }} </p>
                            </div>
                        </div>
                    </div> <!-- end row-->
                </div> <!-- end widget-rounded-circle-->
